...
// Setting up the path to json file containing last 3 years prices for the cotton
const cotton_json_path = "./data/periods/three_years.json";
...
const from = date.year - 3 + "-" + ("0" + (date.month)).slice(-2) + "-" + ("0" + date.day).slice(-2);
